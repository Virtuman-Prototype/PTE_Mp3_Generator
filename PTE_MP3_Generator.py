...
# 这里的 CSS 负责把滑块从“廉价红”变成“森林绿”
st.markdown("""
    <style>
    /* 1. 修改滑块 (Slider) 的核心颜色 */
    /* 进度条颜色 */
    div[data-baseweb="slider"] > div > div {
        background: #1F6859 !important;
    }
    /* 滑块圆点颜色 */
    div[data-baseweb="slider"] [role="slider"] {
        background-color: #1F6859 !important;
        border: 2px solid #1F6859 !important;
    }
    /* 滑块上方数值颜色 */
    ...
    .stButton button:hover {
        background-color: #2a8a77 !important; 
