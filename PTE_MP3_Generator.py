...
# 注入 CSS：全面银色/灰黑色调，彻底去除红色
st.markdown("""
    <style>
    /* 1. 修改滑块 (Slider) 的轨道和点为银色/黑色 */
    div[data-baseweb="slider"] > div > div {
        background: #C0C0C0 !important; /* 银色轨道 */
    }
    div[data-baseweb="slider"] [role="slider"] {
        background-color: #333333 !important; /* 深灰滑块点 */
        border: 2px solid #C0C0C0 !important;
    }

    /* 2. 关键：把滑块下方的文字（如“极慢”、“标准”）从红色改为银灰色 */
    [data-testid="stTickBarMinMax"], 
    [data-testid="stSliderTickBar"] div,
    div[data-testid="stMarkdownContainer"] p {
        color: #8E8E8E !important; /* 优雅的银灰色文字 */
    }
    
    /* 针对 select_slider 的特定标签颜色 */
